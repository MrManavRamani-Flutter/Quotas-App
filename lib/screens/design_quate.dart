...
class Design_Quate extends StatefulWidget {
  const Design_Quate({super.key});

  @override
  State<Design_Quate> createState() => _Design_QuateState();
}

class _Design_QuateState extends State<Design_Quate> {
